  ...
  return (
    <>
      ...
      <section className="services">
        <h1 className="services__title">Мобильная съемка / Визуальная концепция</h1>
        <div className="services__container">
          <div className="services-card">
            ...
            <ul className="services-card__list">
              ...
              <li>— До 30 фотографий в обработке + исходники + маленькие видео без монтажа</li>
              <li>— За 1,5 часа съёмки можно снять 1-2 образа в нескольких локациях</li>
              <li>
                дополнительные расходы (аренда студий, работа моделей, реквизит и тд.) оплачиваются отдельно клиентом
              </li>
            </ul>
          ...
          <div className="services-card">
            ...
            <ul className="services-card__list">
              ...
              <li>— Создание визуальной концепции на основе выявленных смыслов и целей, подбор референсов</li>
              <li>— Мудборд с локациями, образами, позами</li>
          ...
          <div className="services-card">
            ...
            <ul className="services-card__list">
              ...
              <li>— Анализ существующего визуала</li>
              <li>— Распаковка личности/бренда</li>
              <li>— Составление сетки визуала на 15 кадров на основе выявленных смыслов и целей, подбор референсов</li>
              <li>дополнительно можно оформить аватарку, шапку профиля, актуальные и обложки на reels</li>
            </ul>
          ...
          <div className="services-card">
            ...
            <ul className="services-card__list">
              <li>
                — Любой ваш запрос на тему визуала, профиля, ведения инстаграма, обработки, оформления сторис и т.д.
              </li>
              <li>— Готовлю материал по вашему вопросу в виде презентации и созваниваемся по видео звонку</li>
              <li>— Делюсь лайфхаками, полезными приложениями, даю практические советы</li>
